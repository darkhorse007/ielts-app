...
BACKEND_LOG="${BACKEND_LOG:-/tmp/ielts-stability-page-backend.log}"
BACKEND_PID_FILE="${BACKEND_PID_FILE:-/tmp/ielts-stability-page-backend.pid}"
FRONTEND_LOG="${FRONTEND_LOG:-/tmp/ielts-stability-page-frontend.log}"
FRONTEND_PID_FILE="${FRONTEND_PID_FILE:-/tmp/ielts-stability-page-frontend.pid}"
...
echo "local stability page e2e passed"
