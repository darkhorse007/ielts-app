...
BACKEND_LOG="${BACKEND_LOG:-/tmp/ielts-observability-storage-backend.log}"
BACKEND_PID_FILE="${BACKEND_PID_FILE:-/tmp/ielts-observability-storage-backend.pid}"
FRONTEND_LOG="${FRONTEND_LOG:-/tmp/ielts-observability-storage-frontend.log}"
FRONTEND_PID_FILE="${FRONTEND_PID_FILE:-/tmp/ielts-observability-storage-frontend.pid}"
...
echo "local observability storage e2e passed"
